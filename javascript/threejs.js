  ...
  return fetch(filepath)
    .then((response) => {
      if (!response.ok) {
        ...
        throw new Error(
          `Failed to fetch data from ${filepath} (Status: ${response.status})`
        );
      }
...
// Removed mock data fetching - now gets real data from robot via threejs.init.js
console.log(
  "Three.js visualization initialized - waiting for robot voxel data..."
);
